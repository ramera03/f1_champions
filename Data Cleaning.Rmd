...
# Data from https://www.kaggle.com/datasets/rohanrao/formula-1-world-championship-1950-2020/data?select=constructor_standings.csv
...
status <- read.csv("data/status.csv", header = TRUE)
races <- read.csv("data/races.csv", header = TRUE)
constructor_standings <- read.csv("data/constructor_standings.csv", header = TRUE)

# Data from https://www.kaggle.com/datasets/dubradave/formula-1-drivers-dataset?select=F1DriversDataset.csv
